...
authorList: ['me', 'C-D Hillenbrand', 'J A Milton', 'C Siddoway', 'G Foster', 'P Wilson', 'J S Wellner', 'S M Bohaty']
authorString: 'Thomas Arney, Claus-Dieter Hillenbrand, J. Andy Milton, Christine Siddoway, Gavin Foster, Paul Wilson, Julia S. Wellner, and Steven M. Bohaty'
...
publicationShort: EGU 2024
publicationFull: European Geosciences Union (EGU) Annual General Meeting, Vienna, Austria
...
(9 minutes plus questions, captions available)

<iframe width="100%" style="aspect-ratio: 16/9" src="https://www.youtube.com/embed/q_8_W8CwMnE?si=OAsUaEYYIQZs-dE9" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>