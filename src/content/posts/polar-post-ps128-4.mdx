...
<Figure wide src="../assets/img/Atka-Bay-berg.jpg" alt="A panoramic photo of a gigantic tabluar iceberg surrounded by ice and water, with small groups of penguins." caption="Atka Bay, near the Neumayer polar research station. The small black figures are mostly Adélie penguins." />
...
<Figure wide src="../assets/img/polarstern-pool.png" alt="A light blue swimming pool with a basketball floating on the surface of the water, which is at a surprising angle." caption="The ship's swimming pool, during some modest weather conditions. In really heavy weather, the pool is drained." />
...
<Figure src="../assets/img/PS128-snowy-deck-work.jpg" alt="Two men working with what looks like a steel pipe on a snowy ship's deck, with sea ice in the background." caption="Preparing the gravity corer before deployment." />
...
<Figure sideCaption height="700" src="../assets/img/PS128-GC-at-dusk.jpg" alt="A steel pipe with a wider cylinder at the top hanging off a wire from a winch on a ship at sunset." caption="Deploying the gravity corer at dusk in sea ice." />
...
<Figure src="../assets/img/PS128-corer-on-deck.jpg" alt="Two people are hard at work on a ship's working deck, while a man in muddy orange hi-vis clothing stands back and smiles at the camera." caption="&ldquo;Too many cooks spoil the broth&rdquo; – sometimes it's best to let the others do the work." credit="Jule Müller" />
...
<Figure src="../assets/img/PS128-micropalaeo.jpg" alt="Two scientists in a green laboratory looking through microscopes which are tied down to the table." caption="The position of ship-board micropalaeontologist involves attempting to identify tiny fossils through a moving microscope." credit="Bernhard Diekmann"/>
