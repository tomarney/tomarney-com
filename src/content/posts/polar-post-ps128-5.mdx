...
import moloTransfer from '../../assets/img/ps128-molo-transfer.jpg'

<Figure sideCaption height="600" src={moloTransfer} alt="A helicopter carrying a load slung under it in a net on a cable passes the ship's funnel, headed towards the ice in the background." caption="Transferring people and equipment to shore in (and under) the ship's helicopter." />
...
import adelieSwimming from '../../assets/img/adelie-swimming_ale.jpg'

<Figure src={adelieSwimming} alt="A little penguin swimming in perfectly still blue water" caption="Our little penguin friend." credit="Alejandro Cammareri"/>
...
import moloLifeboat from '../../assets/img/ps128-molo-lifeboat.jpg'

<Figure wide src={moloLifeboat} alt="An orange ship's lifeboat motors across a still blue bay against a backdrop of bright white ice and snow." caption="Lifeboat test in the bay off Molodezhnaya Station." />
...
import petrel from '../../assets/img/petrel.jpg'

<Figure src={petrel} alt="A small flying bird with a brown back and head, and a white belly and face." caption="A petrel(?) wheeling around us." />
...
import xueLong from '../../assets/img/ps128-bridge-xue-long.jpg'

<Figure wide src={xueLong} alt="View of a red ship through the windows of a ships bridge. Many people are watching, all in silhouette against the windows." caption="Excitement on the bridge at meeting the Chinese research icebreaker <i>Xue Long 2</i> by chance in the middle of nowhere - our first direct contact with other people for a month." />
