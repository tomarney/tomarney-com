...
- We present a possible proxy for Thwaites Glacier dynamics, based on an anomalous less radiogenic cluster of lead isotopes in ice-rafted K-feldspar sand grains.


### Future work

- Confirm and characterise the Pb-Pb clusters with other geochemical systems:
  - dating the same grains used for the Pb analyses with the new *in-situ* Rb-Sr mass-shift laser ablation method
  - elemental analysis (including REE)
